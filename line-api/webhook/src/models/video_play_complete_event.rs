...
impl VideoPlayCompleteEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, reply_token: String, video_play_complete: models::VideoPlayComplete) -> VideoPlayCompleteEvent {
