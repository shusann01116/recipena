...
impl UnsendEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, unsend: models::UnsendDetail) -> UnsendEvent {
        UnsendEvent {
            r#type,
            source: None,
            timestamp,
