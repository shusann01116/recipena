...
impl AccountLinkEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, link: models::LinkContent) -> AccountLinkEvent {
        AccountLinkEvent {
            r#type,
            source: None,
            timestamp,
