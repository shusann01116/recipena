...
impl JoinEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, reply_token: String) -> JoinEvent {
        JoinEvent {
            r#type,
            source: None,
            timestamp,
