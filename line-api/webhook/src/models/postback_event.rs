...
impl PostbackEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, postback: models::PostbackContent) -> PostbackEvent {
        PostbackEvent {
            r#type,
            source: None,
            timestamp,
