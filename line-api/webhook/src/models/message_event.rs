...
impl MessageEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, message: models::MessageContent) -> MessageEvent {
        MessageEvent {
            r#type,
            source: None,
            timestamp,
