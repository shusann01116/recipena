...
impl ActivatedEvent {
    ...
    pub fn new(r#type: String, timestamp: i64, mode: models::EventMode, webhook_event_id: String, delivery_context: models::DeliveryContext, chat_control: models::ChatControl) -> ActivatedEvent {
        ActivatedEvent {
            r#type,
            source: None,
            timestamp,
